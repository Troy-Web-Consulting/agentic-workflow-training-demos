...
Margaret reported being double-charged for the Enterprise plan in February. Finance confirmed the duplicate charge of $2,400. Refund processed on 3/4. She also requested that future invoices be sent to [EMAIL_REDACTED] instead of her personal inbox. Margaret was satisfied with the resolution but noted this is the second billing error in six months.

### Case #4218 — Data Export Failure
Customer: Robert Jennings
Email: [EMAIL_REDACTED]
Phone: [PHONE_REDACTED]
SSN on file (legacy field, flagged for removal): [SSN_REDACTED]
Account #: SMB-10934
...
SAML SSO integration failing intermittently — affects ~200 users at DevNova. Auth team identified the issue as clock skew between our IdP and theirs. Temp fix deployed 3/7 (increased token validity window to 5 minutes). Permanent fix in Sprint 14. Aisha requested a direct line to our engineering team for future SSO issues; for now she can reach the auth team lead at [EMAIL_REDACTED] or [PHONE_REDACTED].
...
> "Support response time has been excellent. Got a call back from [PHONE_REDACTED] within 20 minutes of filing my ticket." — Jennifer Mosley, [EMAIL_REDACTED]
...
> "We've had three outages in the past month. Starting to evaluate alternatives. Contact me to discuss — [EMAIL_REDACTED], [PHONE_REDACTED]" — Derek Arnold, FitSync

> "The export bug is killing us. Please see case #4218." — Robert Jennings

## Action Items

1. **Billing team**: Audit all Enterprise accounts for duplicate charges in Feb cycle. Contact: [EMAIL_REDACTED]
...
4. **Support ops**: Remove legacy SSN fields from customer records (compliance req, deadline March 31). Affected records flagged in the CRM — contact [EMAIL_REDACTED] or call [PHONE_REDACTED] for the removal procedure
